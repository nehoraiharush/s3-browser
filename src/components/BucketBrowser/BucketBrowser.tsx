...
export const BucketBrowser: React.FC<BucketBrowserProps> = ({ onBucketSelect, selectedBucket }) => {
  ...
  if (!activeAccount) {
    return <Typography>Please add and select an AWS Account from the sidebar.</Typography>;
  }
